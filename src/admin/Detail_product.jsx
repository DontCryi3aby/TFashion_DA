...
export default function Detail_product() {
  ...
  const handledelete = async (id) => {
    await axios
      .delete(`${process.env.REACT_APP_BASEURL}/api/detail_product/${id}`)
      .then((response) => {
  ...
  useEffect(() => {
    axios
      .get(`${process.env.REACT_APP_BASEURL}/api/detaildanhmuc`)
      .then((response) => {
  ...
  useEffect(() => {
    axios
      .get(`${process.env.REACT_APP_BASEURL}/api/detailthongtin`)
      .then((response) => {
  ...
  async function save(event) {
    ...
    try {
      ...
      const response = await axios.post(
        `${process.env.REACT_APP_BASEURL}/api/add_detail`,
        formData,
        {
          headers: {
                ...
                >
                  ...
                  {danhmucsp.map((dm) => (
                    <option key={dm.id} value={dm.id}>
                      {dm.id}.{dm.title} ({dm.category.namecategory})
                    </option>
                  ))}
                </select>
              </div>
